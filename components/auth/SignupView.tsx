    ...
    <div className="flex flex-col items-center justify-center pt-10">
      <div className="w-full max-w-md p-8 space-y-6 bg-gray-800/40 rounded-lg shadow-xl border border-indigo-500/20">
        <div className="flex flex-col items-center space-y-2">
          ...
          <p className="text-center text-gray-400">Join UnBind to save and manage your analyses</p>
        </div>
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          <div>
            <label htmlFor="username-signup" className="block text-sm font-medium text-gray-300">Username</label>
            <div className="mt-1">
              <input
                id="username-signup"
                name="username"
